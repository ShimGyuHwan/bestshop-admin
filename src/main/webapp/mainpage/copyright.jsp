...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mainpage/css/copyright.css"/>
<title>Insert title here</title>
</head>
<body>
    <div class="copyrightm_css">
	<div class="copyrightm_csss">
    <ul>
    <li>회사소개</li>
    <li>이용약관</li>
    <li>개인정보취급</li>
    ...
    <div>
    <span>CUSTOMER CENTER</span><span id="cgen"></span>
    </div>
    </div>
    </div>
    <div class="copyright_css" id="copyright">
    <div class="copyrightm_csss2">
    <ul>
    <li id="cp1"></li>
    <li id="cp2"></li>
    <li id="cp3"></li>
    <li id="cp4">ㅤㅤㅤcopyright (c)  All Rights reserved.</li>
    <li class="bizno"><a id="bizno">[사업자정보확인]</a></li>
    </ul>
    <div>
    <ol>
    <li>BANK INFO</li>
...
<script src="mainpage/js/copyright.js?v=2">
</script>
</html>