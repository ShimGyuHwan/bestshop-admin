...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mainpage/css/banner.css"/>
<title>Insert title here</title>
</head>
<body>

<div id="banner" class="banner_css">
<div class="slidecontainer">
<div class="slide" id="slide">
<div class="banner_item item1"><a class="bannerurl"><img class="bannerimg" src="./ico/banner0.png"></a></div>
<div class="banner_item item2"><a class="bannerurl"><img class="bannerimg" src="./ico/banner0.png"></a></div>
<div class="banner_item item3"><a class="bannerurl"><img class="bannerimg" src="./ico/banner0.png"></a></div>
</div>
<ul class="banner_paging"><li class="bpaging"></li ><li class="bpaging"></li><li class="bpaging"></li></ul>
</div>
</div>
