...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mainpage/css/mdpick.css"/>
<title>Insert title here</title>
</head>
<body>
<div id="mdpick" class="mdpick_css">

<div class="mdpicktitle">
		SPECIAL PRODUCT
</div>
<div id="mdpicklist" class="mdpicklist">
<ul id="mdlistul">
<li><img src="./ico/part1.jpg"></li>
<li>
<ol>
<li><img src="admin/product_img/16883656701251.jpg"></li>
<li>asdassd</li>
<li>80000</li>
</ol>
<span class="productdc">83%</span>
</li>
</ul>
</div>
</div>
</body>
<script src="mainpage/js/mdpick.js"></script>
</html>