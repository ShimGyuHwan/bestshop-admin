...
<li><div>⠀상품코드</div><input type="text" style="width:130px;" name="pcode"  id="pcode" readonly><span class="listck" onclick="codeck()">중복확인</span><font size="2" style="line-height: 40px; color:#333;">⠀※ 상품코드는 절대 중복되지 않도록 합니다.</font></li>
